...
(0, _ava.default)("/GET incidents", async function (t) {
  _avaHttp.default.getResponse("http://localhost:8000/incidents").then(resp => {
    console.log("wii");
    t.true(true);
  }).catch(ex => {
    console.log("ne");
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/5ef72e295a87a7847265a6eff713b75e.js.map