...
(0, _ava.default)("/POST incidents", async t => {
  ...
  const resp = await _avaHttp.default.postResponse("http://localhost:8000/incidents").catch(err => {
    ...
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(err, "arguments/0/left/object").response, "arguments/0/left") === _rec2._capt(undefined, "arguments/0/right"), "arguments/0"), {
      content: "t.true(err.response === undefined)",
      filepath: "test/index.js",
      line: 13,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"err\",\"range\":[7,10]},\"property\":{\"type\":\"Identifier\",\"name\":\"response\",\"range\":[11,19]},\"computed\":false,\"range\":[7,19]},\"right\":{\"type\":\"Identifier\",\"name\":\"undefined\",\"range\":[24,33]},\"range\":[7,33]}],\"range\":[0,34]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"err\",\"range\":[7,10]},{\"type\":{\"label\":\".\"},\"range\":[10,11]},{\"type\":{\"label\":\"name\"},\"value\":\"response\",\"range\":[11,19]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[20,23]},{\"type\":{\"label\":\"name\"},\"value\":\"undefined\",\"range\":[24,33]},{\"type\":{\"label\":\")\"},\"range\":[33,34]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(resp, "arguments/0/left") === 200, "arguments/0"), {
    content: "t.true(resp === 200)",
    filepath: "test/index.js",
    line: 16,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[7,11]},\"right\":{\"type\":\"NumericLiteral\",\"value\":200,\"range\":[16,19]},\"range\":[7,19]}],\"range\":[0,20]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[7,11]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[12,15]},{\"type\":{\"label\":\"num\"},\"value\":200,\"range\":[16,19]},{\"type\":{\"label\":\")\"},\"range\":[19,20]}]",
    visitorKeys: _powerAssertVisitorKeys
  })); // t.true(resp === false, "The response should've been \"false\" because no parameters were sent");
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/070456b68addf95484b1a9f13366bee0.js.map