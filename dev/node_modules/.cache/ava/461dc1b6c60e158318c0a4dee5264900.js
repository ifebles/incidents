...
(0, _ava.default)("/POST incidents", async t => {
  const resp = await _avaHttp.default.post("http://localhost:8000/incidents").then(resp => {
    ...
    t.true(_rec2._expr(_rec2._capt(_rec2._capt(resp, "arguments/0/left") === 1, "arguments/0"), {
      content: "t.true(resp === 1)",
      filepath: "test/index.js",
      line: 14,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[7,11]},\"right\":{\"type\":\"NumericLiteral\",\"value\":1,\"range\":[16,17]},\"range\":[7,17]}],\"range\":[0,18]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[7,11]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[12,15]},{\"type\":{\"label\":\"num\"},\"value\":1,\"range\":[16,17]},{\"type\":{\"label\":\")\"},\"range\":[17,18]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  }).catch(err => {
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/461dc1b6c60e158318c0a4dee5264900.js.map