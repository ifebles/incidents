...
(0, _ava.default)("/POST incidents", async t => {
  const resp = await _avaHttp.default.post("http://localhost:8000/incidents").then(resp => {
    var _rec2 = new _powerAssertRecorder();

    t.true(_rec2._expr(_rec2._capt(_rec2._capt(resp, "arguments/0/left") === "hola", "arguments/0"), {
      content: "t.true(resp === \"hola\")",
      filepath: "test/index.js",
      line: 14,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[7,11]},\"right\":{\"type\":\"StringLiteral\",\"value\":\"hola\",\"range\":[16,22]},\"range\":[7,22]}],\"range\":[0,23]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[7,11]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[12,15]},{\"type\":{\"label\":\"string\"},\"value\":\"hola\",\"range\":[16,22]},{\"type\":{\"label\":\")\"},\"range\":[22,23]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  }).catch(err => {
    ...
    console.log(err);
    t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(err, "arguments/0/left/object").response, "arguments/0/left") === _rec3._capt(undefined, "arguments/0/right"), "arguments/0"), {
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/504621d3909c3196361055997ce76e32.js.map