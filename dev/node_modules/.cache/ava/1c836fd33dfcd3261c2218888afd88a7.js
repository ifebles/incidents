...
(0, _ava.default)("/GET incidents", async t => {
  ...
  const resp = await _avaHttp.default.get("http://localhost:8000/incidents");
...
(0, _ava.default)("/GET localities", async t => {
  ...
  const resp = await _avaHttp.default.get("http://localhost:8000/localities");
  ...
  t.false(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(resp, "arguments/0/left/object").length, "arguments/0/left") >= 1, "arguments/0"), {
    content: "t.false(resp.length >= 1, \"The result must have at least 1 register to test with\")",
    filepath: "test/index.js",
    line: 21,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"false\",\"range\":[2,7]},\"computed\":false,\"range\":[0,7]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\">=\",\"left\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[8,12]},\"property\":{\"type\":\"Identifier\",\"name\":\"length\",\"range\":[13,19]},\"computed\":false,\"range\":[8,19]},\"right\":{\"type\":\"NumericLiteral\",\"value\":1,\"range\":[23,24]},\"range\":[8,24]},{\"type\":\"StringLiteral\",\"value\":\"The result must have at least 1 register to test with\",\"range\":[26,81]}],\"range\":[0,82]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"false\"},\"value\":\"false\",\"range\":[2,7]},{\"type\":{\"label\":\"(\"},\"range\":[7,8]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[8,12]},{\"type\":{\"label\":\".\"},\"range\":[12,13]},{\"type\":{\"label\":\"name\"},\"value\":\"length\",\"range\":[13,19]},{\"type\":{\"label\":\"</>\"},\"value\":\">=\",\"range\":[20,22]},{\"type\":{\"label\":\"num\"},\"value\":1,\"range\":[23,24]},{\"type\":{\"label\":\",\"},\"range\":[24,25]},{\"type\":{\"label\":\"string\"},\"value\":\"The result must have at least 1 register to test with\",\"range\":[26,81]},{\"type\":{\"label\":\")\"},\"range\":[81,82]}]",
    visitorKeys: _powerAssertVisitorKeys
...
// })
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/1c836fd33dfcd3261c2218888afd88a7.js.map