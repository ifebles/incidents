...
(0, _ava.default)("/POST incidents/ incidents/${incidentId}/archive/", async t => {
  ...
  const archivePost = await _avaHttp.default.post(`http://localhost:8000/incidents/${resp}/archive/`);
  t.true(_rec4._expr(_rec4._capt(_rec4._capt(resp, "arguments/0/left") === true, "arguments/0"), {
...
//     t.true(typeof resp === typeof [], "The response is not an object");
// });
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/622b0aa6d2293149f8c8d81d7ea652a8.js.map