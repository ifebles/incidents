...
(0, _ava.default)("/GET incidents", function (t) {
  return _avaHttp.default.getResponse("http://localhost:8000/incidents").then(resp => {
    console.log(resp);
    console.log("wii");
    t.true(true);
  }).catch(ex => {
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/77ece96487ddcf59ca2e5fe0813f9e9d.js.map