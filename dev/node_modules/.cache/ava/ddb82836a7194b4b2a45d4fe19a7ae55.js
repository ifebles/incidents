...
(0, _ava.default)("/POST incidents", async t => {
  ...
  console.log(resp);
  t.true(_rec2._expr(_rec2._capt(_rec2._capt(resp, "arguments/0/left") === false, "arguments/0"), {
    content: "t.true(resp === false, \"Response must be false since no parameter was sent\")",
    filepath: "test/index.js",
    line: 28,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[7,11]},\"right\":{\"type\":\"BooleanLiteral\",\"value\":false,\"range\":[16,21]},\"range\":[7,21]},{\"type\":\"StringLiteral\",\"value\":\"Response must be false since no parameter was sent\",\"range\":[23,75]}],\"range\":[0,76]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[7,11]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[12,15]},{\"type\":{\"label\":\"false\"},\"value\":\"false\",\"range\":[16,21]},{\"type\":{\"label\":\",\"},\"range\":[21,22]},{\"type\":{\"label\":\"string\"},\"value\":\"Response must be false since no parameter was sent\",\"range\":[23,75]},{\"type\":{\"label\":\")\"},\"range\":[75,76]}]",
    visitorKeys: _powerAssertVisitorKeys
  }), "Response must be false since no parameter was sent"); // t.true(resp === 200);
  // t.true(resp === false, "The response should've been \"false\" because no parameters were sent");
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/ddb82836a7194b4b2a45d4fe19a7ae55.js.map