...
(0, _ava.default)("/GET incidents", async function (t) {
  try {
    ...
    t.true(_rec2._expr(_rec2._capt(ex, "arguments/0"), {
      content: "t.true(ex)",
      filepath: "test/index.js",
      line: 38,
      async: true,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"Identifier\",\"name\":\"ex\",\"range\":[7,9]}],\"range\":[0,10]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"ex\",\"range\":[7,9]},{\"type\":{\"label\":\")\"},\"range\":[9,10]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  }
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/cacbe40e894c97286374c7d74d3b1616.js.map