...
(0, _ava.default)("/POST incidents/ incidents/${incidentId}/archive/", async t => {
  ...
  const archivePost = await _avaHttp.default.post(`http://localhost:8000/incidents/${incidents[incidents.length - 1]}/archive/`);
  t.true(_rec6._expr(_rec6._capt(_rec6._capt(resp, "arguments/0/left") === true, "arguments/0"), {
...
//     t.true(typeof resp === typeof [], "The response is not an object");
// });
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/2d16f0b4aa2d9dcd11cd850ed620e312.js.map