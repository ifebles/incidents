...
(0, _ava.default)("/GET incidents", t => {
  var _rec = new _powerAssertRecorder();

  const resp = _avaHttp.default.getResponse("http://localhost:8000/incidents");

  t.true(_rec._expr(_rec._capt(_rec._capt(typeof resp, "arguments/0/left") === "object", "arguments/0"), {
    content: "t.true(typeof resp === \"object\", \"The response is not an object\")",
    filepath: "test/index.js",
    line: 8,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"UnaryExpression\",\"operator\":\"typeof\",\"argument\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[14,18]},\"prefix\":true,\"range\":[7,18]},\"right\":{\"type\":\"StringLiteral\",\"value\":\"object\",\"range\":[23,31]},\"range\":[7,31]},{\"type\":\"StringLiteral\",\"value\":\"The response is not an object\",\"range\":[33,64]}],\"range\":[0,65]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"typeof\"},\"value\":\"typeof\",\"range\":[7,13]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[14,18]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[19,22]},{\"type\":{\"label\":\"string\"},\"value\":\"object\",\"range\":[23,31]},{\"type\":{\"label\":\",\"},\"range\":[31,32]},{\"type\":{\"label\":\"string\"},\"value\":\"The response is not an object\",\"range\":[33,64]},{\"type\":{\"label\":\")\"},\"range\":[64,65]}]",
...
(0, _ava.default)("/POST incidents", async t => {
  ...
  const resp = await _avaHttp.default.postResponse("http://localhost:8000/incidents").catch(err => {
    var _rec2 = new _powerAssertRecorder();

    t.true(_rec2._expr(_rec2._capt(_rec2._capt(_rec2._capt(err, "arguments/0/left/object").statusCode, "arguments/0/left") >= 400, "arguments/0"), {
      content: "t.true(err.statusCode >= 400)",
      filepath: "test/index.js",
      line: 13,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\">=\",\"left\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"err\",\"range\":[7,10]},\"property\":{\"type\":\"Identifier\",\"name\":\"statusCode\",\"range\":[11,21]},\"computed\":false,\"range\":[7,21]},\"right\":{\"type\":\"NumericLiteral\",\"value\":400,\"range\":[25,28]},\"range\":[7,28]}],\"range\":[0,29]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"err\",\"range\":[7,10]},{\"type\":{\"label\":\".\"},\"range\":[10,11]},{\"type\":{\"label\":\"name\"},\"value\":\"statusCode\",\"range\":[11,21]},{\"type\":{\"label\":\"</>\"},\"value\":\">=\",\"range\":[22,24]},{\"type\":{\"label\":\"num\"},\"value\":400,\"range\":[25,28]},{\"type\":{\"label\":\")\"},\"range\":[28,29]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  });
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(resp, "arguments/0/left/object").statusCode, "arguments/0/left") === 200, "arguments/0"), {
    content: "t.true(resp.statusCode === 200)",
    filepath: "test/index.js",
    line: 16,
    async: true,
    ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"BinaryExpression\",\"operator\":\"===\",\"left\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"resp\",\"range\":[7,11]},\"property\":{\"type\":\"Identifier\",\"name\":\"statusCode\",\"range\":[12,22]},\"computed\":false,\"range\":[7,22]},\"right\":{\"type\":\"NumericLiteral\",\"value\":200,\"range\":[27,30]},\"range\":[7,30]}],\"range\":[0,31]}",
    tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"resp\",\"range\":[7,11]},{\"type\":{\"label\":\".\"},\"range\":[11,12]},{\"type\":{\"label\":\"name\"},\"value\":\"statusCode\",\"range\":[12,22]},{\"type\":{\"label\":\"==/!=\"},\"value\":\"===\",\"range\":[23,26]},{\"type\":{\"label\":\"num\"},\"value\":200,\"range\":[27,30]},{\"type\":{\"label\":\")\"},\"range\":[30,31]}]",
    visitorKeys: _powerAssertVisitorKeys
  })); // t.true(resp === false, "The response should've been \"false\" because no parameters were sent");
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/0b265fc9f181fd83173d04f1b47375ac.js.map