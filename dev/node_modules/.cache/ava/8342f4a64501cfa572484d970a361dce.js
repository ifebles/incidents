...
(0, _ava.default)("/GET incidents", function (t) {
  return _avaHttp.default.get("http://localhost:8000/incidents").then(resp => {
    ...
    t.true(_rec._expr(_rec._capt(_rec._capt(typeof resp, "arguments/0/left") === _rec._capt(typeof _rec._capt([], "arguments/0/right/argument"), "arguments/0/right"), "arguments/0"), {
      content: "t.true(typeof resp === typeof [])",
  ...
  // {
  //     const resp = await http.getResponse("http://localhost:8000/incidents");
  //     t.true(typeof resp === "object", "The response is not an object");
  // }
  // catch (ex)
  // {
  //     console.log(ex)
  //     t.true(ex ? true: false)
  // }
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/8342f4a64501cfa572484d970a361dce.js.map