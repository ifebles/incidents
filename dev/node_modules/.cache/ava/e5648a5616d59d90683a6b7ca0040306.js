...
(0, _ava.default)("/POST incidents", async t => {
  const resp = await _avaHttp.default.post("http://localhost:8000/incidents").then(resp => {
    ...
    t.true(_rec._expr(_rec._capt(_rec._capt(resp, "arguments/0/left") === "hola", "arguments/0"), {
...
(0, _ava.default)("/GET incidents", t => {
  ...
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(typeof resp, "arguments/0/left") === "object", "arguments/0"), {
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/e5648a5616d59d90683a6b7ca0040306.js.map