...
(0, _ava.default)("/POST incidents", t => {
  ...
  _avaHttp.default.post("http://localhost:8000/incidents").then(resp => {
    t.true(true, "Epa");
  }).catch(err => {
    t.true(true, "No epa");
  });
...
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/9b1cdb0dbb279705aa9e6e31fc93b96d.js.map