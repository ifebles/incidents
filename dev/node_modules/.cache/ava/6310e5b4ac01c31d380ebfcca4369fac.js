...
const mongoCol_incidents = "dbIncident"; // test("/POST incidents", async t => {
//     const resp = await http.post("http://localhost:8000/incidents", { kind: "robbery" })
//     .then((resp) => {
//         t.true(resp === "hola");
//     })
//     .catch((err) => {
//         t.true(err.response === undefined);
//     });
//     // t.true(resp === 200);
//     // t.true(resp === false, "The response should've been \"false\" because no parameters were sent");
// })

(0, _ava.default)("/GET incidents", async function (t) {
  try {
    var _rec = new _powerAssertRecorder();

    const resp = await _avaHttp.default.getResponse("http://localhost:8000/incidents");
    ...
    t.true(_rec2._expr(_rec2._capt(ex, "arguments/0/test") ? true : false, {
      content: "t.true(ex ? true : false)",
      filepath: "test/index.js",
      line: 38,
      async: true,
      ast: "{\"type\":\"CallExpression\",\"callee\":{\"type\":\"MemberExpression\",\"object\":{\"type\":\"Identifier\",\"name\":\"t\",\"range\":[0,1]},\"property\":{\"type\":\"Identifier\",\"name\":\"true\",\"range\":[2,6]},\"computed\":false,\"range\":[0,6]},\"arguments\":[{\"type\":\"ConditionalExpression\",\"test\":{\"type\":\"Identifier\",\"name\":\"ex\",\"range\":[7,9]},\"consequent\":{\"type\":\"BooleanLiteral\",\"value\":true,\"range\":[12,16]},\"alternate\":{\"type\":\"BooleanLiteral\",\"value\":false,\"range\":[19,24]},\"range\":[7,24]}],\"range\":[0,25]}",
      tokens: "[{\"type\":{\"label\":\"name\"},\"value\":\"t\",\"range\":[0,1]},{\"type\":{\"label\":\".\"},\"range\":[1,2]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[2,6]},{\"type\":{\"label\":\"(\"},\"range\":[6,7]},{\"type\":{\"label\":\"name\"},\"value\":\"ex\",\"range\":[7,9]},{\"type\":{\"label\":\"?\"},\"range\":[10,11]},{\"type\":{\"label\":\"true\"},\"value\":\"true\",\"range\":[12,16]},{\"type\":{\"label\":\":\"},\"range\":[17,18]},{\"type\":{\"label\":\"false\"},\"value\":\"false\",\"range\":[19,24]},{\"type\":{\"label\":\")\"},\"range\":[24,25]}]",
      visitorKeys: _powerAssertVisitorKeys
    }));
  }
});
//# sourceMappingURL=/home/mael/Documents/projects/incidents/dev/node_modules/.cache/ava/6310e5b4ac01c31d380ebfcca4369fac.js.map